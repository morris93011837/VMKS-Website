        ...
        >
            <List style={{paddingTop:'0'}}>
              <ListItem disablePadding>
                <ListItemButton onClick={() => scrollToSection(sessionA)} style={{
                  ...
                  <ListItemText style={{color:colors.DarkSlateGray}}>MKS簡介</ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton onClick={() => scrollToSection(sessionB)} style={{
                  border: '3px solid #3D96A5', 
                  borderBottomWidth: '0px',
                  borderRightWidth: '0px',
                  borderRadius: '0px', 
                  ...
                  <ListItemText style={{color:colors.DarkSlateGray}}>管理員班表</ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem disablePadding>
                <ListItemButton onClick={() => scrollToSection(sessionC)} style={{
                    border: '3px solid #3D96A5', 
                    borderRadius: '0px', 
                    borderRightWidth: '0px',
                    textAlign: 'center',
                  }}>
                    <ListItemText style={{color:colors.DarkSlateGray}}>使用者規範</ListItemText>
                </ListItemButton>
              </ListItem>
            </List>
